...
public:
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadWrite, Category = "CharacterMovement") ////////Temporal
		bool Key = false;
...
public:
	...
	UFUNCTION(BlueprintImplementableEvent, BlueprintCallable, Category = "Movement/Events")
